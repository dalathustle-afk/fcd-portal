...
export const metadata: Metadata = {
  title: 'Sản phẩm FCD',
  description: 'Danh sách sản phẩm cà phê đặc sản FCD — tra cứu theo gu, dòng sản phẩm, giá. Arabica Cầu Đất và Robusta Buôn Ma Thuột.',
}
  ...
  return (
    <>
      <section className="pt-24 pb-10 bg-[#1C0F07]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          ...
          <p className="text-[#EDE4D8]/60 max-w-xl">
            Tìm kiếm theo tên, mã sản phẩm, gu hoặc dòng sản phẩm
          </p>
        </div>
      </section>
      ...
      <section className="py-10 bg-[#FDF6ED]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6">
          <ProductFilters products={products} flavors={flavorCategories} />
        </div>
      </section>
    </>
  )
