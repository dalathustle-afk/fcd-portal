...
export const scaGrades = [
  ...
  },
  {
    ...
    market: 'Thực trạng báo động: Đây là nguồn nguyên liệu chính của các ly cà phê lề đường 6.000đ–10.000đ bị tẩm ướp hóa chất.',
    color: '#C0392B',
    bgColor: '#2D0A08',
    tag: '⛔ Cà phê vỉa hè 6.000đ–10.000đ',
