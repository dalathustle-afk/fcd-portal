...
export const products: ProductRecord[] = [
  ...
  // ── GU PHỔ THÔNG ────────────────────────────────────────────────
  {
    ...
    alt: 'Cà Phê FCD Gu Phổ Thông P — Bảng giá niêm yết FCD',
  ...
  },
  {
    ...
    featured: false,
    image: '/images/products/page-summary.png',
    alt: 'Cà Phê FCD Gu Phổ Thông P3 — Bảng giá niêm yết FCD',
    sourceRef: 'FCD-Bang-gia-niem-yet-KH-le-100226-1.pdf tr.2',
    todoImage: false,
  },
  ...
  // ── GU TRUYỀN THỐNG ─────────────────────────────────────────────
  {
    ...
    featured: false,
    image: '/images/products/page-truyen-thong.png',
    alt: 'Cà Phê FCD Gu Truyền Thống C — Bảng giá niêm yết FCD',
  ...
  },
  {
    ...
    featured: false,
    image: '/images/products/page-truyen-thong.png',
    alt: 'Cà Phê FCD Gu Truyền Thống C3 — Bảng giá niêm yết FCD',
    sourceRef: 'FCD-Bang-gia-niem-yet-KH-le-100226-1.pdf tr.3',
    todoImage: false,
  },
  ...
  // ── GU ĐẬM VỊ ───────────────────────────────────────────────────
  {
    ...
    group: 'gu-dam-vi',
    origin: 'Arabica Cầu Đất & Robusta Buôn Ma Thuột',
    flavorNotes: ['Sô-cô-la', 'Mạch nha', 'Hạnh nhân'],
    descriptionShort: '100% Robusta Culi chế biến ướt — đậm vị, crema tốt, phù hợp pha sữa và espresso.',
    sizes: ['250g', '500g', '1kg', '2kg'],
    prices: [
    ...
    featured: true,
    image: '/images/products/page-dam-vi.png',
    alt: 'Cà Phê FCD Gu Đậm Vị B3 — Bảng giá niêm yết FCD',
  ...
  // ── GU CÂN BẰNG ─────────────────────────────────────────────────
  {
    ...
    descriptionShort: '80% Robusta + 20% Arabica Cầu Đất — cân bằng, medium roast, hương caramel nhẹ.',
    sizes: ['250g', '500g', '1kg', '2kg'],
    prices: [
    ...
    featured: true,
    image: '/images/products/page-can-bang.png',
    alt: 'Cà Phê FCD Gu Cân Bằng A3 — Bảng giá niêm yết FCD',
  ...
  // ── GU TINH TÚY ──────────────────────────────────────────────────
  {
    ...
    group: 'gu-tinh-te',
    origin: 'Robusta 50% Buôn Ma Thuột + Arabica 50% Cầu Đất 1650m',
    flavorNotes: ['Sô-cô-la', 'Hạnh nhân', 'Trái cây', 'Gia vị cay'],
    roastLevel: 'Medium Roast',
    descriptionShort: '50% Robusta + 50% Arabica Cầu Đất cao độ — tinh túy, phù hợp pour-over và filter.',
    sizes: ['250g', '500g', '1kg', '2kg'],
    prices: [
    ...
    featured: true,
    image: '/images/products/page-tinh-tuy.png',
    alt: 'Cà Phê FCD Gu Tinh Túy CAO1 — Bảng giá niêm yết FCD',
  ...
  // ── GU NGUYÊN BẢN ───────────────────────────────────────────────
  {
    ...
    group: 'gu-nguyen-ban',
    origin: 'Catimor 100% Cầu Đất — chế biến ướt',
    flavorNotes: ['Sô-cô-la', 'Caramel', 'Mạch nha', 'Trái cây'],
    descriptionShort: '100% Catimor chế biến ướt — nguyên bản nhất trong dải sản phẩm FCD, giữ trọn terroir Cầu Đất.',
    sizes: ['250g', '500g', '1kg', '2kg'],
    prices: [
    ...
    featured: true,
    image: '/images/products/page-tinh-tuy.png',
    alt: 'Cà Phê FCD Gu Nguyên Bản O1 — Bảng giá niêm yết FCD',
    sourceRef: 'FCD-Bang-gia-niem-yet-KH-le-100226-1.pdf tr.6',
    todoImage: false,
  },
  ...
  // ── PHIN GIẤY ───────────────────────────────────────────────────
  {
    ...
    featured: false,
    image: '/images/products/page-phin-giay.png',
    alt: 'Phin Giấy FCD C3 — Bảng giá niêm yết FCD',
  ...
  },
  {
    ...
    featured: false,
    image: '/images/products/page-phin-giay.png',
    alt: 'Phin Giấy FCD B3 — Bảng giá niêm yết FCD',
    sourceRef: 'FCD-Bang-gia-niem-yet-KH-le-100226-1.pdf tr.7',
    todoImage: false,
  },
  {
    ...
    featured: false,
    image: '/images/products/page-phin-giay.png',
    alt: 'Phin Giấy FCD A3 — Bảng giá niêm yết FCD',
    sourceRef: 'FCD-Bang-gia-niem-yet-KH-le-100226-1.pdf tr.7',
    todoImage: false,
  },
  ...
  // TODO: Confirm exact prices from PDF — listed as category, specific prices need verification
  {
    ...
    alt: 'Dụng cụ cà phê FCD — Bảng giá niêm yết FCD',
