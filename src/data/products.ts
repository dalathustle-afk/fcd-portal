...
export const products: ProductRecord[] = [
  ...
  // ── GÓI AN NHIÊN 12KG ───────────────────────────────────────────
  {
    ...
    code: 'ANCF.B3',
    name: 'Gói An Nhiên 12kg — B3',
    group: 'an-nhien-combo',
    descriptionShort: 'Gói combo 12kg gu Đậm Vị B3 — tiết kiệm và ổn định cho văn phòng, đối tác.',
    sizes: ['combo'],
    prices: [],
    featured: false,
    image: '/images/products/ancf-b3.jpg',
    alt: 'Gói An Nhiên 12kg B3 FCD',
    sourceRef: 'FCD-Bang-gia-niem-yet-KH-le-100226-1.pdf',
    todoImage: true,
  },
  {
    ...
    code: 'ANCF.A3',
    name: 'Gói An Nhiên 12kg — A3',
    group: 'an-nhien-combo',
    descriptionShort: 'Gói combo 12kg gu Cân Bằng A3 — lý tưởng cho văn phòng nhiều khẩu vị.',
    sizes: ['combo'],
    prices: [],
    featured: false,
    image: '/images/products/ancf-a3.jpg',
    alt: 'Gói An Nhiên 12kg A3 FCD',
    sourceRef: 'FCD-Bang-gia-niem-yet-KH-le-100226-1.pdf',
    todoImage: true,
  },
  {
    ...
    code: 'ANCF.MIX',
    name: 'Gói An Nhiên 12kg — Mix',
    group: 'an-nhien-combo',
    descriptionShort: 'Gói combo 12kg Mix nhiều gu — phù hợp cho văn phòng muốn đa dạng hương vị.',
    sizes: ['combo'],
    prices: [],
    featured: false,
    image: '/images/products/ancf-mix.jpg',
    alt: 'Gói An Nhiên 12kg Mix FCD',
    sourceRef: 'FCD-Bang-gia-niem-yet-KH-le-100226-1.pdf',
    todoImage: true,
  },
]

// TODO: Add exact prices for dụng cụ, hộp quà, gói An Nhiên 12kg
// once confirmed from full PDF price table.
